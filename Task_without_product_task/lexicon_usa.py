class Lexicon:
    ...
    electricity_cost_text = "An electric vehicle needs electricity for driving, which is typically cheaper per mile than gasoline and diesel. This attribute represents the <b>electricity costs per 100 mile driven</b> in this electric vehicle. The total costs are determined by the efficiency of the electric vehicle, the costs to produce and distribute the electricity, and governmental taxes."
    gasoline_cost_text = "This attribute represents the <b>gasoline costs per 100 mile driven</b> for a gasoline-fueled vehicle of comparable size to the electric vehicle of this offer. These costs are determined by the typical fuel efficiency of cars of this size, the costs to produce and distribute gasoline, and governmental taxes. By comparing the gasoline costs to the electricity costs of the electric vehicle, you can calculate how much money you would save each month by driving electric instead of gasoline."
    ...
    policy_benefits_high_income_text = "This attribute represents the average subsidy received by high-income households (more than $133,000 post-tax annual income) for the adoption of an electric vehicle in the last year."
    policy_benefits_low_income_text = "This attribute represents the average subsidy received by low-income households (less than $32,000 post-tax annual income) for the adoption of an electric vehicle in the last year."
    policy_burden_high_income_text = "This attribute indicates how much CO2 tax on emissions from gasoline and diesel had to be paid by high-income households (more than $133,000 post-tax annual income) in the last year. This tax was on the total amount of gasoline or diesel that these households used for driving their personal vehicle."
    policy_burden_low_income_text = "This attribute indicates how much CO2 tax on emissions from gasoline and diesel had to be paid by low-income households (less than $32,000 post-tax annual income) in the last year. This tax was on the total amount of gasoline or diesel that these households used for driving their personal vehicle."
