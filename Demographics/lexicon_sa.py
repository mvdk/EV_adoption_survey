class Lexicon:
    ...
    km_day_label = "How many kilometers do you drive on average <i>per day</i>?"
    km_year_label = "How many kilometers do you drive on average <i>per year</i>?"
