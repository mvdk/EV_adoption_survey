class Lexicon:
    ...
    transition_info = 'Auf den nächsten Seiten stellen wir Ihnen noch ein paar generelle Fragen zu Ihren Meinungen. Bitte beantworten Sie die folgende Verständnisfrage und klicken Sie dann auf "Weiter", um fortzufahren.'
