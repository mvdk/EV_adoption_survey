class Lexicon:
    ...
    new_used = "<u>Neuwagen oder Gebrauchtwagen:</u>"
    ...
    new_used_text = "Dieses Merkmal gibt an, ob das Elektrofahrzeug <b>neu oder gebraucht</b> verkauft wird. Ein neues Fahrzeug wurde noch nie benutzt, ein gebrauchtes hatte bereits einen Vorbesitzer. Gebrauchtwagen sind oft günstiger, können aber Gebrauchsspuren aufweisen."
    ...
    adopters_text = "Dieses Merkmal zeigt den <b>Prozentsatz der Menschen in Ihrer Einkommensgruppe, die derzeit ein Elektrofahrzeug fahren</b>."
    ...
    product_intro_text5 = "Wir bitten Sie, für jedes Angebot anzugeben, ob Sie sich vorstellen können das Elektroauto zu kaufen, wenn Sie Ihr aktuelles <b><i>Hauptfahrzeug</b></i> ersetzen müssten."
    ...
    policy_benefits_high_income_text = "Dieses Merkmal zeigt die durchschnittliche Subvention, die Haushalte mit einem Einkommen über 56.000 €  netto im letzten Jahr für die Anschaffung eines Elektrofahrzeugs erhalten haben."
    policy_benefits_low_income_text = "Dieses Merkmal zeigt die durchschnittliche Subvention, die Haushalte mit einem Einkommen unter 19.000 € netto im letzten Jahr erhalten haben."
    policy_burden_high_income_text = "Dieses Merkmal zeigt, wie viel CO2-Steuer auf Benzin und Diesel Haushalte mit hohem Einkommen (über 56.000 €)im letzten Jahr durchschnittlich bezahlt haben, basierend auf deren Treibstoffverbrauch."
    policy_burden_low_income_text = "Dieses Merkmal zeigt, wie viel CO2-Steuer auf Benzin und Diesel Haushalte mit niedrigem Einkommen (unter 19.000 €) im letzten Jahr durchschnittlich bezahlt haben, basierend auf deren Treibstoffverbrauch."
