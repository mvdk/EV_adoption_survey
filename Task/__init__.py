...
class Constants(BaseConstants):
    ...
    possible_orders = [
        ...
        ['product_v1','product_v3'],
        ['product_v2','product_v3'],
        ['product_v1','product_v4'],
        ['product_v2','product_v4'],
    ]
        ...
        try:
            if block == 'policy_mix_support':
                ...
                if block == 'policy_outcome_fairness':
                    ...
                    #     attributes = attributes_version_3_medium,
                    #     if 'shuffled_attributes_disruption' not in player.participant.vars:
                    #         keys_list_disruption = list(attributes.keys())
                    #         # UNCOMMENT FUNCTION BELOW TO RANDOMIZE ATTRIBUTE ORDER
                    #         #random.shuffle(keys_list_disruption)
                    #         player.participant.vars['keys_list_disruption'] = keys_list_disruption
                    #         shuffled_attributes = {key: attributes[key] for key in keys_list_disruption}
                    #         player.participant.vars['shuffled_attributes_disruption'] = shuffled_attributes
                    #     else:
                    #         shuffled_attributes = {key: attributes[key] for key in player.participant.vars['keys_list_disruption']}
