class Lexicon:
    ...
    consent_bullet3 = 'Hypothetically decide for or against some product alternatives.'

    duration = 'Duration: '
    consent_p3 = 'Participation in this study will require approximately 15 minutes of your time.'
