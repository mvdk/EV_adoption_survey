class Lexicon:
    ...
    mobile = "Sorry, this experiment does not allow mobile browsers. Please return to the Prolific website and paste this code: CTCWY1X4"
    next = "Next"

    # Consent Text
    consent_p1 = 'Thank you for your interest in taking part in this study. <br><br> This study is supervised by dr. Marten van der Kam, MSc Anne Günther, MSc Lukas Engel, (University of Basel, Switzerland) and prof. Ulf Hahnel (Leuphana University of Lüneburg, Germany).'
    ...
    consent_bullet2 = 'Complete a set of questionnaires. You will be asked about your attitudes and believes on different topics.'
    consent_bullet3 = 'Hypothetically decide for or against some product alternatives and policy packages.'

    duration = 'Duration: '
    consent_p3 = 'Participation in this study will require approximately 25 minutes of your time.'
